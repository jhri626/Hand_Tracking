...
ps_aa = np.array([[400,0,-400],[300,0,-300],[300,0,-300],[300,0,-300]]) #AA same order with calibration posture
...
class Finalnode:
    ...
    def joint_to_motor(self,q_pos):  # TODO : check the logic after param tuning
        for i in range(4):
            ...
            desired_pos_aa[0] = init_aa[0] + ps_aa[0,0] + int((ps_aa[0,2]-ps_aa[0,0]) * (q_pos[0]))
