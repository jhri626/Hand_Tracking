...
/*
 * modification of https://github.com/Le0nX/ModernRoboticsCpp modernRobotics.cpp
...
namespace mr {
	...
	*/
    ...
    const Eigen::Vector3d& p1)
    {
        ...
        Eigen::Matrix3d SO3 = MatrixExp3(VecToso3(screw*theta));
    ...
    const Eigen::Vector3d& p2)
{
    ...
    Eigen::Matrix4d T_rel = TransInv(T1) * T2;
